...
public class APiTest extends Base{
	...
	public void communicationDetails() {
		...
		Response response = httpRequest.request(Method.GET,"https://api.communitymatrimony.com/api/webservicecall.php?filename=showRecMsgCurl&MatriId=MDA281774&Gender=2&MessageAction=RMPENDING&MsgType=1,2&Page=1&OrderBy=Date_Received%20DESC&FilterFlag=3");
		...
		public void view_verify() throws InterruptedException {
			System.setProperty("webdriver.chrome.driver","C:\\Users\\Jothi\\.eclipse\\API_Testing\\driver\\chromedriver.exe");
	...
	try {
		...
		//	System.out.println("Religion : "+Religion1);
			...
			SubCaste1 = driver.findElement(By.xpath("//span[contains(text(),'Subcaste - ')]//following::span[1]")).getText().trim();
			System.out.println("SubCaste : "+ SubCaste1);
			
			Education1 = driver.findElement(By.xpath("//span[contains(text(),'Education - ')]//following::span[1]")).getText().trim();
