...
public class thanika_test extends Base {
	WebDriver driver;
	...
	public void communicationDetails() {
		...
		RestAssured.baseURI = "https://api.communitymatrimony.com/api/webservicecall.php?filename=showRecMsgCurl&MatriId=BRH2994315&Gender=2&MessageAction=RMPENDING&MsgType=1,2&Page=1&OrderBy=Date_Received%20DESC&FilterFlag=3";
		RequestSpecification httpRequest = RestAssured.given();

		Response response = httpRequest.request(Method.GET,
				"https://api.communitymatrimony.com/api/webservicecall.php?filename=showRecMsgCurl&MatriId=BRH2994315&Gender=2&MessageAction=RMPENDING&MsgType=1,2&Page=1&OrderBy=Date_Received%20DESC&FilterFlag=3");
		...
		System.out.println( "size " + profile_details.size());
		for (int i = 0; i < profile_details.size(); i++) {
			...
			// System.out.println(Heig);
			/*
			 * String[] Heigg = Heig.split(" ft "); String Heigh = Heigg[0].toString(); //
			 * System.out.println(Heigh); String[] Heighh = Heigg[1].split(" in"); String
			 * Heigt = Heighh[0].toString(); System.out.println(Heigt); String Heighgt =
			 * Heigh+"."+Heigt; System.out.println(Heighgt); Float Height =
			 * Float.parseFloat(Heighgt); System.out.println("Height : "+ Height);
			 */
	...
	@Test(priority = 1)
	public void view_verify() throws InterruptedException {
		...
		if (maritalStatus.equalsIgnoreCase("Unmarried")) {
			...
			String age = driver.findElement(By.xpath("//span[contains(text(),'Age - ')]//following::span[1]"))
					.getText();
			...
			try {
				...
				// Religion1 =
				// driver.findElement(By.xpath("//*[@id=\"strictflag\"]/div[20]/div[1]/span[2]")).getText().trim();
				// System.out.println("Religion : "+Religion1);

				SubCaste1 = driver.findElement(By.xpath("//span[contains(text(),'Subcaste - ')]//following::span[1]"))
						.getText().trim();
				System.out.println("SubCaste : " + SubCaste1);

				Education1 = driver.findElement(By.xpath("//span[contains(text(),'Education - ')]//following::span[1]"))
						.getText().trim();
				System.out.println("Education : " + Education1);

			} catch (Exception e) {
				System.out.println("no subcaste found.......");
			}
		}
	}
}