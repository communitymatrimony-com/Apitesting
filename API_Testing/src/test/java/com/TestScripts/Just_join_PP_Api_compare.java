...
public class Just_join_PP_Api_compare extends Base {
	...
	public void viewpro() throws InterruptedException {
		...
		RestAssured.baseURI = "https://www.communitymatrimony.com/api/webservicecall.php?filename=searchcurl&Module=LatestMatches&SortBy=Last_Login%20DESC&EnablePhotoRequest=1&MatriId=CHY458603&PackageName=com.community.matrimony&AppVersionCode=149&SignalStrength=&AppVersion=6.0&EncryptId=daca61b5635cbfc7f008ac0d90118c2d262e30f4&Referrer=DashBoard&SrchTime=1&NetworkType=WIFI&UniqueId=f8ec22a268&Page=1&days=30&mima=yes&DeviceVersion=8.1.0&igOpt=1&DeviceModel=SM-G610F&refpp=true&TokenId=&DevicePlatform=Android&OutputType=2&AppType=2&ignoredOpt=1&CarrierName=&resultperpage=20&TimeStamp=";

		RequestSpecification httpRequest = RestAssured.given();

		Response response = httpRequest.request(Method.GET,
				"https://www.communitymatrimony.com/api/webservicecall.php?filename=searchcurl&Module=LatestMatches&SortBy=Last_Login%20DESC&EnablePhotoRequest=1&MatriId=CHY458603&PackageName=com.community.matrimony&AppVersionCode=149&SignalStrength=&AppVersion=6.0&EncryptId=daca61b5635cbfc7f008ac0d90118c2d262e30f4&Referrer=DashBoard&SrchTime=1&NetworkType=WIFI&UniqueId=f8ec22a268&Page=1&days=30&mima=yes&DeviceVersion=8.1.0&igOpt=1&DeviceModel=SM-G610F&refpp=true&TokenId=&DevicePlatform=Android&OutputType=2&AppType=2&ignoredOpt=1&CarrierName=&resultperpage=20&TimeStamp=");
		/*
...
//Total values getting from response 
		/*
		 * Float totaal = Float.parseFloat(value1);
		 * 
		 * float tot = (float) (totaal / 10.0); System.out.println(tot); int total =
		 * (int) Math.ceil(tot);
		 */
		/*
		 * int total=Integer.parseInt(value1); System.out.println(total);
		 */
		...
		for (int j = 0; j < response1.size(); j++) {
			...
			if (!maritalStatus.equals("Any") || !maritalStatus.equals("Unmarried")) {
