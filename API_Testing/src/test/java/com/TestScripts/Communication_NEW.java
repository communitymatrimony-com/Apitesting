...
public class Communication_NEW extends Base{
	...
	//	System.out.println(ERRORDESC+" . ' . ' ");
     ...
     //  int total = Math.round(tot);
        ...
        for (int i = 1; i <=total; i++) { 
        	...
        	RestAssured.baseURI = "https://api.communitymatrimony.com/api/webservicecall.php?filename=showRecMsgCurl&MatriId=BRH1393126&Gender=2&MessageAction=RMPENDING&MsgType=1,2&Page="+i+"&OrderBy=Date_Received%20DESC&FilterFlag=0";

    		RequestSpecification httpRequest1 = RestAssured.given();

    		Response response1 = httpRequest1.request(Method.GET,
    				"https://api.communitymatrimony.com/api/webservicecall.php?filename=showRecMsgCurl&MatriId=BRH1393126&Gender=2&MessageAction=RMPENDING&MsgType=1,2&Page="+i+"&OrderBy=Date_Received%20DESC&FilterFlag=0");
	...
	public void Inbox_verify() throws InterruptedException {
		System.setProperty("webdriver.chrome.driver",
				"C:\\Users\\Jothi\\.eclipse\\API_Testing\\driver\\chromedriver.exe");
